...
dependencies {
    ...
    project(Modules.characterDetailsPublic)
    project(Modules.characterDetailsImpl)
    project(Modules.charactersListPublic)
    project(Modules.charactersListImpl)
    project(Modules.favoritesPublic)
    project(Modules.favoritesImpl)
