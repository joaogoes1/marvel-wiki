...
class RemoveSavedFavoriteUseCaseImplTest {

    private val repository: CharacterRepository = mockk()
    val useCase = RemoveSavedFavoriteUseCaseImpl(repository)
    ...
    private fun prepareScenario(
        ...
        coEvery { repository.removeSavedFavorite(any<CharacterModel>()) } returns result
    }
}